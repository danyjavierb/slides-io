...
CPPPATH_NODE = '/var/www/slides-io/env-io/include/node'
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g', '-Wall', '-O3']
...
LIBDIR = '/var/www/slides-io/env-io/lib/node_modules'
LIBPATH_HIREDIS = '../deps/hiredis'
LIBPATH_NODE = '/var/www/slides-io/env-io/lib'
LIBPATH_ST = '-L%s'
LIB_HIREDIS = 'hiredis'
LIB_ST = '-l%s'
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/var/www/slides-io/env-io/lib/node_modules'
PREFIX = '/usr/local'
PREFIX_NODE = '/var/www/slides-io/env-io'
